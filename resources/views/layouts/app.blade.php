<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth"> {{-- Added scroll-smooth for navbar links --}}
...
<head>
  ...
  <title>@yield('title', config('app.name', 'Laravel')) - Solutions by Jabbar Ali Panggabean</title>
  ...
  <!-- Gunakan font modern Plus Jakarta Sans -->
